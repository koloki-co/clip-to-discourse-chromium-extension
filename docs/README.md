...
These guides describe the extension as it is implemented. Start with the architecture before changing behavior, then use the focused guides for common maintenance work.
